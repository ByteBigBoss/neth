...
import { Python } from '@/components/icons/skills/icons'
        ...
        <div className='w-full'>
          <WrapperBody>
            <div className='border rounded-[12px]'>
              <motion.div
                className='w-full h-[200px] from-[#fafafa] to-white dark:from-[#101010] dark:to-black bg-gradient-to-t rounded-[12px] relative flex flex-col items-center'>
                ...
                <div className='absolute bottom-0 left-[20px]'>
                  <Image src={`/gm/s1/run-${sprite}.png`} alt={"Sprite"} width={80} height={80} className='object-cover' />
                </div>
                ...
                <div className='absolute bottom-[-100px]'>
                  <div className="w-[212px] h-[212px] border-x border-t rounded-full relative  bg-[#00000013] backdrop-blur-sm flex justify-center items-center">
                    ...
                    <NextUiImage src='/me/nethmina.webp' alt={SiteMetadata.legalName} width={200} height={200} className='object-cover rounded-full' />
                  </div>
                </div>
            ...
            <div className='pt-[120px] flex flex-col items-center text-center'>
              ...
              {/* NAME */}
              <div className={cn(righteous.className, "uppercase text-[2rem] leading-[32px]")}>{SiteMetadata.legalName}</div>

              {/* USERNAME */}
              <div className={"pt-[10px] text-secondaryT pb-[2px]"}>{Site.gitHubUser}</div>
      ...
      <section className='w-full flex flex-col items-center pt-[60px]'>
        <WrapperBody>
          <div className='w-full grid grid-cols-3 gap-[10px]'>
            ...
            <div className='w-full flex flex-col gap-[10px] '>
              ...
              <div className='w-full h-[255px] bg-[#f7f7f7] dark:bg-[#1A1A1A] border rounded-[12px] py-[24px] px-[24px]'>
                ...
                <AnimatedShinyText className="inline-flex items-center justify-center  py-1 transition ease-out hover:text-purple-600 hover:duration-500 hover:dark:text-purple-500">
                  <span className='text-[26px] font-semibold'>{AboutContent.bento.B1.title}</span>
                </AnimatedShinyText>

                <div className='text-[14px] font-medium opacity-80 pt-3'>{AboutContent.bento.B1.description}</div>
            ...
            {/* COL2 */}
            <div className='w-full bg-[#f7f7f7] dark:bg-[#1A1A1A] flex-1 rounded-[12px] border'>
        ...
        <WrapperBody>
          <div className='flex flex-col items-center '>
              ...
              <div className='flex flex-col items-center text-center pb-[60px]'>
                <div className='text-[26px] font-semibold'>{AboutContent.KB.title}</div>
                <div className='text-[15px] font-medium text-secondaryT'>{AboutContent.KB.description}</div>
              </div>
              ...
              <div className='flex flex-wrap justify-center'>
                ...
                colors={skill.colors} 
                icon={<IconComponent className='fill-black dark:fill-white group-hover/canvas-card:fill-white'/>} />
                  )
                })}                
              </div>
